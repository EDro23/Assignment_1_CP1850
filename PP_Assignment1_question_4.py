...
while True:
    print(60*"=") # Heading liner for top of cost input
    ...
    if input("\nContinue? (y/n): ").lower() != "y":
        print("="*60)     # Continue loop for the entire program.
        print("Bye!")     # Asks user if they want to continue entering numbers into the console.
        break
